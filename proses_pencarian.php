...
while ($row = mysqli_fetch_assoc($resultcari)) {
    ...
    //echo "<td style='padding: 5px;'><strong>ID Barang</strong><br> " . $row['id_produk'] . "</td>";
    echo "<td style='padding: 5 px;'><strong>Kode Barang</strong><br>" . $row['kode_produk'] . "</td>";
    $formatted_harga_jual = "Rp " . number_format($row['harga_jual'], 0, ',', '.');
    echo "<td style='padding: 5px;'><strong>Harga Jual</strong><br> " . $formatted_harga_jual . "</td>";
    echo "<td style='padding: 5px;'><strong>Nama Barang</strong><br>" . $row['nama_produk'] . "</td>";
    echo "<td style='padding: 5px;'><strong>Merk</strong><br>" . $row['merk'] . "</td>";
